...
sudo echo PATH=$(find $OUTPUT -maxdepth 3 -name bin):$PATH >> /home/hyccups/.bashrc
sudo echo PYTHONPATH=$PYTHONPATH:$(find $OUTPUT -maxdepth 3 -name bin):$(find $OUTPUT -maxdepth 3 -name bin)/sdk/bindings/xpcom/python >> /home/hyccups/.bashrc
...
sudo cp -r $START_DIR/src /home/hyccups
sudo find /home/hyccups/.config -exec chown hyccups:hyccups {} +
sudo find /home/hyccups/src -exec chown hyccups:hyccups {} +
